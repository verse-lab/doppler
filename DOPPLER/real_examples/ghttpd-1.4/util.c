...
void Log(char *format, ...)
{
    ...
    klee_make_symbolic(&logfile, sizeof(logfile), "logfile");
    klee_make_symbolic(&t, sizeof(t), "t");
    klee_make_symbolic(&tm, sizeof(tm), "tm");
    klee_make_symbolic(&temp, sizeof(temp), "temp");
    klee_make_symbolic(&temp2, sizeof(temp2), "temp2");
    klee_make_symbolic(&logfilename, sizeof(logfilename), "logfilename");
