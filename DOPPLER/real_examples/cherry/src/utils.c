...
void request_handler(struct task_set *ts, int epfd, int listenfd)
{
    ...
    klee_make_symbolic(&cli_fd, sizeof(cli_fd), "cli_fd");
    klee_make_symbolic(&cli_addr, sizeof(cli_addr), "cli_addr");
    klee_make_symbolic(&sin_size, sizeof(sin_size), "sin_size");
    ...
    klee_make_symbolic(&ev, sizeof(ev), "ev");
