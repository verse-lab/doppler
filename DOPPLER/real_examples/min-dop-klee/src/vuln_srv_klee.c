...
void do_serve(int sockfd)
{
  ...
  while(loop_max>0){
    ...
    // attack entry
    klee_make_symbolic(&g_clfd, sizeof(g_clfd), "g_clfd");
    klee_make_symbolic(&g_is_root, sizeof(g_is_root), "g_is_root");
    klee_make_symbolic(&g_d, sizeof(g_d), "g_d");
    klee_make_symbolic(&g_c, sizeof(g_c), "g_c");
    klee_make_symbolic(&g_p_c, sizeof(g_p_c), "g_p_c");
    klee_make_symbolic(&g_b, sizeof(g_b), "g_b");
    klee_make_symbolic(&g_p_b, sizeof(g_p_b), "g_p_b");
    klee_make_symbolic(&g_a, sizeof(g_a), "g_a");
    klee_make_symbolic(&g_srv, sizeof(g_srv), "g_srv");
    klee_make_symbolic(&TYPE_NONE, sizeof(TYPE_NONE), "TYPE_NONE");
    klee_make_symbolic(&g_p_secret, sizeof(g_p_secret), "g_p_secret");
    klee_make_symbolic(&SECRET, sizeof(SECRET), "SECRET");
    klee_make_symbolic(&g_pp_secret, sizeof(g_pp_secret), "g_pp_secret");
    klee_make_symbolic(&g_p_g_a, sizeof(g_p_g_a), "g_p_g_a");
    klee_make_symbolic(&g_pp_g_a, sizeof(g_pp_g_a), "g_pp_g_a");
    klee_make_symbolic(&g_p_g_is_root, sizeof(g_p_g_is_root), "g_p_g_is_root");
    klee_make_symbolic(&g_pp_g_is_root, sizeof(g_pp_g_is_root), "g_pp_g_is_root");
    klee_make_symbolic(&g_scratch_buf, sizeof(g_scratch_buf), "g_scratch_buf");
    klee_make_symbolic(&g_p_scratch_buf, sizeof(g_p_scratch_buf), "g_p_scratch_buf");
    klee_make_symbolic(&g_pp_scratch_buf, sizeof(g_pp_scratch_buf), "g_pp_scratch_buf");
